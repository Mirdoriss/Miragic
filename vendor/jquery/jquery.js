...
(function(global, factory) {
    ...
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        //对于commonjs和类似commonjs的环境，在这些环境中`
        //存在，执行工厂并获取jquery。
    ...
    //edge< = 12 + Firefox＜＝18—45＋10～11，IE，Safari 5.1 9 + 6 9.1IOS

    //当把exceptions 非严格的代码（例如，ASP.NET 4.5）accesses严格模式

    // arguments.callee.caller（调拨- 13335）。但在jQuery 3.0（2016年），严格的模式应该是普通

    //了，全是这样的attempts guarded试图在一块。
    "use strict";
    ...
    var isFunction = function isFunction(obj) {
        ...
        //（例如，`typeof document.createElement（“object”）==“函数”`）。

        //我们不想将*any*dom节点分类为函数。
